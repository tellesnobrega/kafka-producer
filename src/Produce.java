...
public class Produce {
    ...
    public static void main(String[] args) {
        ...
        Producer<Integer, Map<String, Object>> producer = new Producer<Integer, Map<String,Object>>(config);
        ...
        while(current.getTime() - start.getTime() < TimeUnit.MINUTES.toMillis(time)) {
            ...
            KeyedMessage<Integer, Map<String, Object>> data = new KeyedMessage<Integer, Map<String, Object>>("consumptions", key, outgoingMap);
            producer.send(data);
